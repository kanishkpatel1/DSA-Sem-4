...
// Main Function 
    public static void main(String[] args) {
        ...
        Student s1 = new Student("Vaibhav", "63", 97);
        Student s3 = new Student("Ritik", "46", 88);
        Student s4 = new Student("Divyanshu", "18", 67);
        Student s5 = new Student("Ayush", "12", 98);
        ...
        Student s11 = new Student("Vaibhav", "63", 97);
        Student s31 = new Student("Ritik", "46", 88);
        Student s41 = new Student("Divyanshu", "18", 67);
